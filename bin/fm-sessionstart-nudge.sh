...
# Ownership resolution (including the ancestry walk and its depth) belongs to
# bin/fm-session-lock-lib.sh; this wrapper only decides what to print.
fm_session_lock_owned "$STATE" && exit 0
