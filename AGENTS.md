...
A task the captain is driving is not firstmate's to watch at all: it produces no wake, owes no alarm, and is never peeked at, steered, acked, or relayed out of, for as long as his own signed record stands or he is sitting in its window, and supervision resumes by itself when he leaves (`docs/captain-driven.md`; `bin/fm-ack-lib.sh` owns the predicate).
